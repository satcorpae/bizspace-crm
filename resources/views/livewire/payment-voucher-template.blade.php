    ...
    <div style="width: 1040px; height: 1350px; border: 1px solid black;">
        <div class="tax-invoice-section"            style=
           ...
           <span style="font-size:34px;">
            ...
            >
                <span style="margin-left:10px;font-weight:bold;">PAYMENT NO.</span>
            ...
            <div class="bill-to-section" style="position: absolute;top:162px;">
                <div class="bill-to">
                    <p style="color:white; background-color:rgb(192,0,0);width:360px;padding:4px;">ISSUED TO</p>
            ...
            <div class="table-content" style="position: absolute;top:380px;width:1040px; ">
                <table style="width:1040px;border:1px solid black;height:600px;border-collapse: collapse;border-bottom:none; ">
                    ...
                    <tbody >
                         @php
                              $unserializedAmount = unserialize($item->rate); 
                              $unserializedInvoice = unserialize($item->description);
...
@endphp 
    ...
    <div class="bank-content" style="position: absolute;bottom:550px;margin-left:10px;">
    ...
    <div id="prepared-by"  style="position: absolute; bottom:300px;left:200px;width:500px;text-align:center;">
        <span> FAITH</span>
        <hr style="">
