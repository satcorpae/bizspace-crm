...
<body>
        <img src="{{$image}}" alt="" style="position: absolute;left:5px;top:20px;height:150px;width:340px;">
                ...
                <table style="width:1040px;border:1px solid black;height:600px;border-collapse: collapse;border-bottom:none; ">
                    ...
                    <tbody >
                         @php
                              ...
                              $length = count($unserializedSellingPrice); 
                              
                        @endphp
                            @for ($i = 0; $i < $length; $i++)
                            @php
                                $data = $unserializedSellingPrice[$i];
                                $dis = $unserializedDescription[$i];
                            @endphp
                        <tr >
            ...
            <tr>
                <td style="border: 1px solid black;margin-left:20px;"></td>
                    ...
                    <tr style="background-color: rgb(245, 139, 139); border:none;">
                        ...
                        <td></td>
                        <td rowspan="5" style="margin-left:50px;">
                        ...
                        <td rowspan="5" style="background-color:white;">
                            <div class="amount" >
                                <span style="margin-left:70px;" >{{$item->amount}}</span>
                                <hr 
                                style="height:1px;border:none; margin:0;background-color:black;">
                                @php
                                    $vat = 0.05 * $item->amount;
                                    $TOTAL = $item->amount + $vat;
                                @endphp
                                <span style="margin-left:70px;">{{$vat}}</span>
                                <hr 
                                style="height:1px;border:none; margin:0;background-color:black;">
